...
class Affichage(Thread):
    ...
    def run(self):
        ...
        def lancement_fenetre_manu():
            ...
            bouton_quitter = Button(top, text='Quitter', command=quitter, borderwidth=1,height=4, width=14).grid(row=1, column=1)
            ...
            Bouton_learning_mode = Button(top, text='Learning mode', command=learning_mode, borderwidth=1, height=4, width=14).grid(row=6,
                                                                                                                column=4)
